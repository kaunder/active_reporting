...
class ActiveReporting::FunctionAdapters::DateTruncTest < Minitest::Test
  ...
  def assert_time_effectively_equal(value1, value2)
    assert Time.parse(value1) == Time.parse(value2)
  end
  ...
  def test_date_trunc_returns_minute_data
    ...
    assert_time_effectively_equal(result.first['foo'], '2018-09-29 12:15:00')
  end
  ...
  def test_date_trunc_returns_hourly_data
    ...
    assert_time_effectively_equal(result.first['foo'], '2018-09-29 12:00:00')
  end
  ...
  def test_date_trunc_returns_day_data
    ...
    assert_time_effectively_equal(result.first['foo'], '2018-09-29 00:00:00')
  end
  ...
  def test_date_trunc_returns_monday_for_week_start
    ...
    assert_time_effectively_equal(result.first['foo'], '2018-09-24 00:00:00')
  end
  ...
  def test_week_truncation_when_date_is_a_sunday
    ...
    result = perform_query('week', time)
    assert_time_effectively_equal(result.first['foo'], '2018-05-28 00:00:00')
  end
  ...
  def test_date_trunc_returns_year_data
    ...
    assert_time_effectively_equal(result.first['foo'], '2018-01-01 00:00:00')
  end
  ...
  def test_date_trunc_returns_decade_data
    ...
    if pg?
      ...
      assert_time_effectively_equal(result.first['foo'], '2010-01-01 00:00:00')
    else
      assert_raises ArgumentError do
        perform_query('decade', time)
      end
    end
  end
  ...
  def test_date_trunc_returns_century_data
    ...
    if pg?
      ...
      assert_time_effectively_equal(result.first['foo'], '1701-01-01 00:00:00')
    else
      assert_raises ArgumentError do
        perform_query('century', time)
      end
    end
  end
  ...
  def test_date_trunc_returns_millennium_data
    ...
    if pg?
      ...
      assert_time_effectively_equal(result.first['foo'], '1001-01-01 00:00:00')
    else
      assert_raises ArgumentError do
        perform_query('millenium', time)
      end
    end
  end
end
